...
config_clear_path    = getitem(global_config,  "path.clear",              True)
...
config_fade_kana     = getitem(global_config,   "fade.kana",              None)
...
config_output_html   = getitem(global_config,    "out.html",             False)
config_output_keep   = getitem(global_config,    "out.keep",              True)
